...
class Menu:
    ...
    def upload_captcha_sample(self):
        ...
        client_name = str(input("Please provide the client name: "))
    ...
    def menu_interface(self):
        ...
        while(True):
            ...
            print ("[5] Download a training captcha model")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog="api_client", description=("CAPTCHA22 API Client provides an interface to CAPTCHA22 API Server and the CAPTCHA22 server"))
    ...
    parser.add_argument("--username", default=None, help="Username used for connection to CAPTCHA22, default will be prompted when required")
    parser.add_argument("--password", default=None, help="Password used for connection to CAPTCHA22, default will be prompted when required")
